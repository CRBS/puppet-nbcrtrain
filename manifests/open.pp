class nbcrtrain::open
{
  ...
  $other_packages = [ 'libXft', 'xorg-x11-xauth', 'screen', 'bzip2', 'which', 'rsync', 'gcc', 'gcc-c++', 'python-devel', 'cmake', 'git', 'unzip', 'tree', 'wget','tcsh','xauth', 'qt' ,'qt-devel', 'opencv', 'opencv-python','numpy','numpy-f2py','scipy' ]
